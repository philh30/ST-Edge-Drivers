...
local driver_template = {
  supported_capabilities = {
    ...
    capabilities['platinummassive43262.zoozLedBrightness'],
    capabilities['platinummassive43262.zoozLedColor'],
    capabilities['platinummassive43262.zoozLedMode'],
  },
  capability_handlers = {
--[[
...
--]]
  ...
  sub_drivers = {
    require("zen32-scene-controller")
  },
  lifecycle_handlers = {
    init = device_init,
