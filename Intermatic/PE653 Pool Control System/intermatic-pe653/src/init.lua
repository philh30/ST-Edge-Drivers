...
local driver_template = {
  ...
  supported_capabilities = {
    ...
    capdefs.activeMode.capability,
    capdefs.activeSetpoint.capability,
    capdefs.airOffset.capability,
    ...
    capdefs.firmwareVersion.capability,
    capdefs.heaterFreezeControl.capability,
    capdefs.heaterSafetyConfig.capability,
    capdefs.poolSpaConfig.capability,
    capdefs.poolSpaFreezeControl.capability,
    capdefs.pumpRPM.capability,
    capdefs.pumpSpeed.capability,
    capdefs.pumpTypeConfig.capability,
    capdefs.schedule.capability,
    capdefs.scheduleTime.capability,
    capdefs.schedules.capability,
    capdefs.solarOffset.capability,
    capdefs.tempFreezeControl.capability,
    capdefs.vspFreezeControl.capability,
    capdefs.vspSpeed1.capability,
